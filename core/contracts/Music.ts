...
export interface MusicTrack { id: string; title: string; artists: string[]; album?: string; artworkUrl?: string; durationMs?: number; provider: MusicProviderKind; externalUrl?: string; }
