...
export interface MusicSnapshot { provider?: MusicProviderKind; connected: boolean; capabilities: MusicCapabilities; playback: PlaybackState; queue?: MusicTrack[]; error?: string; debug?: { requestId: number; fetchedAt: string; trackPresent: boolean; trackIdSuffix: string; spotifyTrackSuffix?: string; requestDurationMs?: number }; }
