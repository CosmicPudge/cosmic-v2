...
export type PlaybackMediaType = "music" | "podcast" | "audiobook" | "unknown";
export interface MusicArtist { id?: string; name: string; imageUrl?: string | null; }
export interface MusicTrack { id: string; title: string; artists: string[]; artistProfiles?: MusicArtist[]; album?: string; artworkUrl?: string; durationMs?: number; provider: MusicProviderKind; mediaType?: PlaybackMediaType; subtitle?: string; tertiaryText?: string; externalUrl?: string; }
...
export interface PlaybackState { track?: MusicTrack; mediaType?: PlaybackMediaType; playing: boolean; positionMs: number; durationMs?: number; volume?: number; deviceName?: string; updatedAt: string; }
