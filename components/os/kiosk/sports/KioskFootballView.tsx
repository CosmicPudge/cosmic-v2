...
export default function KioskFootballView({
  ...
  return (
    <div className="kiosk-sports-view kiosk-football-view relative flex h-[100svh] w-full items-center justify-center overflow-hidden px-[clamp(1rem,3vw,3rem)] py-[clamp(1rem,3vh,2.5rem)]">
