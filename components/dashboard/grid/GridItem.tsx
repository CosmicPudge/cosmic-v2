...
export default function GridItem({
  ...
  useDashboardWidgetReadiness(widget.id, ["weather", "calendar", "sports", "garage", "finance", "school", "projects", "notes", "outlook", "music"].includes(widget.id) ? null : "ready");
