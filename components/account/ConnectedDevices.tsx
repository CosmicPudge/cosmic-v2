...
type ControlState = { paused: boolean; pauseReason: "manual" | "preview" | null; currentSlide: string | null };
...
export default function ConnectedDevices() {
  ...
  async function command(action: "pause" | "resume" | "next" | "previous") {
    if (!selectedDeviceId) return;
    const response = await fetch("/api/devices/kiosk-control", { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ deviceId: selectedDeviceId, action }) });
